...
draw_door: # start at v1, use t4
    ...
    sw $t4 10772($v1)
    li $t4 0xb06f0e
    draw4($t4, 2064, 2576, 3088, 9756)
    sw $t4 10256($v1)
    sw $t4 10268($v1)
    sw $t4 10768($v1)
    li $t4 0xc57c10
    draw4($t4, 2068, 2580, 9748, 10260)
    li $t4 0x9b620c
    draw4($t4, 2072, 9752, 10264, 10776)
    li $t4 0x99610c
    sw $t4 2600($v1)
    li $t4 0x9d630c
    sw $t4 3084($v1)
    ...
    sw $t4 1544($v1)
    li $t4 0xc67c10
    draw4($t4, 2052, 2564, 3588, 11268)
    li $t4 0xc87d10
    sw $t4 3076($v1)
    sw $t4 10756($v1)
    li $t4 0x7d4300
    draw4($t4, 4096, 5164, 5676, 6144)
    draw4($t4, 6188, 6700, 9260, 9772)
    sw $t4 10284($v1)
    sw $t4 10796($v1)
    li $t4 0xc07910
    sw $t4 4100($v1)
