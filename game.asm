...
.eqv STAGE_COUNT    12           # size of platforms_end
...
platforms: .word 0 96 124 108 208 400 300 412 0 496 124 508 400 496 508 508 0 0 172 12 16 176 28 236 0 32 12 76 0 432 12 492 224 416 236 444
# address to end of platforms per stage
platforms_end: .word 64 96 144
# stage counter * 4
stage: .word 0
# stage gravity (Δx, Δy) for each stage
stage_gravity: .word 0 4 0 -4 -4 0
